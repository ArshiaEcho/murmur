              ...
              <div className="relative" ref={languageDropdownRef}>
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                    languageFilter !== "all"
                      ? "bg-signal/20 text-signal-ink"
                      : "bg-card-2 text-text/60 hover:bg-card-2"
                  }`}
                >
                ...
                {languageDropdownOpen && (
                  <div className="absolute top-full right-0 mt-1 w-56 bg-bg border border-line rounded-lg shadow-lg z-50 overflow-hidden">
                    <div className="p-2 border-b border-line">
                      <input
                        ...
                        className="w-full px-2 py-1 text-sm bg-card-2 border border-line rounded-md focus:outline-none focus:ring-1 focus:ring-signal"
                      />
                    </div>
